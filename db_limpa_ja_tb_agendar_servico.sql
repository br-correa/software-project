...
--
-- Table structure for table `tb_agendar_servico`
--
...
--
-- Dumping data for table `tb_agendar_servico`
--

LOCK TABLES `tb_agendar_servico` WRITE;
/*!40000 ALTER TABLE `tb_agendar_servico` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_agendar_servico` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-11-03  0:35:03
